        ...
        <div class="container auth-card">
          ...
          <form id="register-form" class="auth-form" novalidate>
            ...
            <div class="auth-field">
              ...
              <input id="register-username" name="username" type="text" autocomplete="username" required placeholder="Ex: mariasilva" />
            </div>
            ...
            <div class="auth-field">
              ...
              <input id="register-password" name="password" type="password" autocomplete="new-password" required placeholder="Mínimo 6 caracteres" />
            </div>
