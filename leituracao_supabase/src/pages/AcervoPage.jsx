  ...
  return (
    <div className="page-section">
      <div className="container space-y-7">
        <section className="hero-shadow overflow-hidden rounded-[32px] bg-crimson-dark px-6 py-10 text-white md:px-10">
          <p className="text-xs font-semibold uppercase tracking-[0.18em] text-secondary">Acervo gratuito</p>
          ...
          <section className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            {categories.map((category) => (
              ...
              >
                ...
                <h2 className="mt-5 font-serif text-3xl text-crimson">{category.label}</h2>
                ...
                <div className="mt-6 text-sm font-semibold text-secondary">Abrir categoria</div>
              </button>
            ))}
          </section>
        )}
