...
const suggestBooks = [
  { icon: "🏛️", title: "A República", author: "Platão", match: "95% match" },
  {
    icon: "💡",
...
const achievements = [
  { title: "Primeiro livro", desc: "Você concluiu o seu 1º livro" },
  { title: "Sequência 7", desc: "7 dias seguidos lendo" },
  { title: "Quiz Master", desc: "15 quizzes respondidos" },
  { title: "Streak 30", desc: "30 dias ativos" },
];
      ...
      <div className="container space-y-6">
          ...
          <section className="bg-white rounded-xl border border-gray-100 p-5 shadow-xs">
            ...
            <div className="rounded-lg bg-cream-dark p-4 flex flex-col md:flex-row md:items-center gap-3 md:gap-5">
              ...
              <div className="flex-1">
                <p className="font-semibold text-navy">Dom Casmurro</p>
                <p className="text-sm text-gray-600">
                  Machado de Assis · Pág. 87 de 256
                </p>
                <div className="h-2 bg-white rounded-full overflow-hidden mt-2">
                  <div className="h-full w-1/3 bg-blue rounded-full" />
                </div>
              </div>
              <button className="px-5 py-2 rounded-full bg-navy text-white text-sm font-semibold hover:bg-navy-light transition-colors">
                Continuar
              </button>
            </div>
          </section>
        ...
        <section className="bg-white rounded-xl border border-gray-100 p-5 shadow-xs">
          <div className="flex items-center justify-between mb-4">
            ...
            <button className="text-sm text-blue font-semibold hover:underline">
              Ver mais
            </button>
          </div>
          ...
          <section className="grid lg:grid-cols-5 gap-4">
            ...
            <article className="lg:col-span-2 bg-white rounded-xl border border-gray-100 p-5 shadow-xs">
              ...
              <ol className="space-y-2 text-sm">
                {[
                  ["1º", "João Pedro", "2.540 XP"],
                  ["2º", "Ana Oliveira", "1.980 XP"],
                  ["3º", "Carlos Ferreira", "1.875 XP"],
                  ["14º", "Maria Santos (você)", "1.240 XP"],
                ].map(([place, name, xp]) => (
                  <li
                    key={name}
                  ...
                  >
                    ...
                    <span className="font-semibold text-gold">{xp}</span>
                  </li>
                ))}
              </ol>
            </article>
